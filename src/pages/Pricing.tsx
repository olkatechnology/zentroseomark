...
const plans = {
  monthly: [
    { name: "Starter", price: "$19", period: "/mo", desc: "Perfect for testing ZentroSEO's capabilities", features: ["1 website", "4 Basic SEO audits", "3 keyword tracking", "Monthly reports", "Email support"], limits: ["Limited to 100 pages scanned", "Basic reporting only"], cta: "Start 3-Day Trial", href: "https://app.zentroseo.com/login?signup=true&plan=starter_monthly" },
    { name: "Standard", price: "$49", period: "/mo", desc: "Great for small businesses and startups", features: ["3 websites", "20 Complete SEO audits per URL", "100 keyword research per URL", "50 keyword tracking per URL", "5 competitor analysis per URL", "Backlink analysis", "Limited AI content writing", "Schema generator", "Weekly reports", "Priority email support"], popular: true, cta: "Start 3-Day Trial", href: "https://app.zentroseo.com/login?signup=true&plan=standard_monthly" },
    { name: "Pro", price: "$99", period: "/mo", desc: "Perfect for growing businesses and agencies", features: ["10 websites", "20 Complete SEO audits per URL", "100 keyword research per URL", "50 keyword tracking per URL", "10 competitor analysis per URL", "Backlink analysis", "Unlimited AI content writing", "Schema generation", "Daily reports", "Auto scheduling reports", "Phone + email support", "White-label reports"], cta: "Start 3-Day Trial", href: "https://app.zentroseo.com/login?signup=true&plan=pro_monthly" },
  ...
  yearly: [
    { name: "Starter", price: "$190", period: "/yr", desc: "Perfect for testing ZentroSEO's capabilities", features: ["1 website", "4 Basic SEO audits", "3 keyword tracking", "Monthly reports", "Email support"], limits: ["Limited to 100 pages scanned", "Basic reporting only"], cta: "Start 3-Day Trial", href: "https://app.zentroseo.com/login?signup=true&plan=starter_yearly" },
    { name: "Standard", price: "$490", period: "/yr", desc: "Great for small businesses and startups", features: ["3 websites", "20 Complete SEO audits per URL", "100 keyword research per URL", "50 keyword tracking per URL", "5 competitor analysis per URL", "Backlink analysis", "Limited AI content writing", "Schema generator", "Weekly reports", "Priority email support"], popular: true, cta: "Start 3-Day Trial", href: "https://app.zentroseo.com/login?signup=true&plan=standard_yearly" },
    { name: "Pro", price: "$990", period: "/yr", desc: "Perfect for growing businesses and agencies", features: ["10 websites", "20 Complete SEO audits per URL", "100 keyword research per URL", "50 keyword tracking per URL", "10 competitor analysis per URL", "Backlink analysis", "Unlimited AI content writing", "Schema generation", "Daily reports", "Auto scheduling reports", "Phone + email support", "White-label reports"], cta: "Start 3-Day Trial", href: "https://app.zentroseo.com/login?signup=true&plan=pro_yearly" },
