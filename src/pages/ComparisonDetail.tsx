...
const ComparisonDetail = () => {
  ...
  if (!comp) {
    return (<Layout><div className="container mx-auto px-4 py-20 text-center"><h1 className="font-display text-3xl font-bold mb-4">{t("comparisonNotFound")}</h1><Link to="/resources/comparisons/" className="text-primary hover:underline">{t("backToComparisons")}</Link></div></Layout>);
  }
